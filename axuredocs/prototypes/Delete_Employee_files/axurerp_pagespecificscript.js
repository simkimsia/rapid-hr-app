...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('EmployeeViewAppointmentsAdd.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('EmployeeViewAppointments.html');
